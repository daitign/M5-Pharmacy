                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Class A" name="product_unit" value="{{ old('product_unit') }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="product_note">Product Description</label>
