...
class SaleController extends Controller
{
    ...
    public function store(StoreSaleRequest $request) {
        DB::transaction(function () use ($request) {
            ...
            ///newly added for removing customer
            $customerId = $request->filled('customer_id') ? $request->customer_id : null;

            $customerName = $customerId ? Customer::findOrFail($customerId)->customer_name : null;
    ...
    //new added for removing customer
    public function show(Sale $sale) {
        abort_if(Gate::denies('show_sales'), 403);
    
        $customer = optional(Customer::find($sale->customer_id));
