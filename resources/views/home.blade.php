            ...
            <div class="col-md-6 col-lg-3">
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            <div class="text-value text-dark">{{ \Modules\Product\Entities\Product::count() }}</div>
            ...
            {{-- <div class="col-md-6 col-lg-3">
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            <div class="text-value text-danger">{{ format_currency(\Modules\Product\Entities\Product::sum('product_cost')) }}</div>
                            <div class="text-muted text-uppercase font-weight-bold small">Expired Products</div>
                        </div>
                    </div>
                </div>
            </div> --}}
            {{-- <div class="col-md-6 col-lg-3">
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            <div class="text-value text-danger">2,110.00</div>
                            <div class="text-muted text-uppercase font-weight-bold small">Expired Products</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        <div class="bg-gradient-success p-4 mfe-3 rounded-left" >
                            <i class="bi bi-building font-2xl"></i>
                        </div>
                        <div>
                            <div class="text-value text-success">{{ \Modules\People\Entities\Supplier::count() }}</div>
                            <div class="text-muted text-uppercase font-weight-bold small">Suppliers</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            <div class="text-value text-danger">{{ $count }}</div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card border-0">
                    <div class="card-body p-0 d-flex align-items-center shadow-sm">
                        ...
                        <div>
                            <div class="text-value text-dark">
                                {{ $expiresIn7DaysCount }}
                            </div>
