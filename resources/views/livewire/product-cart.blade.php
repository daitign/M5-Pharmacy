    ...
    <div class="form-row">
        {{-- <div class="col-lg-4">
            <div class="form-group">
                ...
                <input wire:model.lazy="global_tax" type="number" class="form-control" name="tax_percentage" min="0" max="100" value="{{ $global_tax }}" >
            </div>
        </div> --}}
        ...
        {{-- <div class="col-lg-4">
            <div class="form-group">
                ...
                <input wire:model.lazy="shipping" type="number" class="form-control" name="shipping_amount" min="0" value="0" step="0.01">
            </div>
        </div> --}}
    </div>
</div>
