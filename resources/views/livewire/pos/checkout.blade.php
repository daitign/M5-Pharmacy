                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select wire:model="customer_id" id="customer_id" class="form-control">
                            <option>Select Customer <span class="text-danger">(Optional)</span></option>
            ...
            <div class="form-row justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="form-group text-center">
                        <label for="discount_percentage" style="display: block; margin: 0 auto;">DISCOUNT(%)</label>
                        <input wire:model.lazy="global_discount" type="number" class="form-control" min="100" max="100" value="{{ $global_discount }}" required style="border-radius: 20px;">
                    </div>
                </div>
